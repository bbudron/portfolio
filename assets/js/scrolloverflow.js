...
(function (window, document, Math) {
    ...
    function createDefaultScrollbar (direction, interactive, type) {
        ...
        if ( type === true ) {
            ...
            indicator.style.cssText = '-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;position:absolute;background:#a5a8d2c9;border:1px solid rgba(255,255,255,0.9);border-radius:0px';
        }
        ...
        if ( direction == 'h' ) {
            if ( type === true ) {
                scrollbar.style.cssText += ';height:7px;left:2px;right:15px;bottom:0';
                indicator.style.height = '100%';
            }
            scrollbar.className = 'iScrollHorizontalScrollbar';
        } else {
            if ( type === true ) {
                scrollbar.style.cssText += ';width:7px;bottom:2px;top:2px;right:15px';
